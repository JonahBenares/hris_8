        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <a class="btn btn-success btn-block" href="print_emp_status.php?id=<?php echo $id ?>">
                            <span class="zmdi zmdi-print mr-1"></span> Print
                        </a>
                    </div>
                </div>
                <br>
                            ...
                            <tr>
                                ...
                                <td width="27%" class="brd-btm" id = "borderemp">
                                    <select class ="form-control brd-none"  name="emp_status" id="emp_status" <?php echo (($status != 'Active') ? ' style= "display:none;"' : ''); ?>>
                                        ...
                                        <option value = "Part-Time" <?php echo (($emp_status=='Part-Time') ? ' selected' : ''); ?>>Part-Time</option>
                                        <option value = "Fixed-Term Worker" <?php echo (($emp_status=='Fixed-Term Worker') ? ' selected' : ''); ?>>Fixed-Term Worker</option>
                                    </select> 
                                </td>
                                <td width="5%"></td>
...
<script>
    ...
    $('#email').on('blur',function(){
        $.ajax({
            type: "POST",
            url: "save-temp.php",
            data:'email='+encodeURIComponent($(this).val())+'='+id
        });
    });
