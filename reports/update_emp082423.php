                        ...
                        <tr>
                            <td colspan = "15">
                                ...
                                <select class =" btn  btn-sm btn-warning btn-fill" style="color:black;height:100%" name="emp_status" id="emp_status">
                                    ...
                                    <option value = "For Exam" <?php echo (($row['emp_status'] == 'Part-Time') ? ' selected' : ''); ?>>Part-Time</option>
                                    <option value = "For Exam" <?php echo (($row['emp_status'] == 'Retainer') ? ' selected' : ''); ?>>Retainer</option>
                                    <option value = "For Exam" <?php echo (($row['emp_status'] == 'OJT / Student Intern') ? ' selected' : ''); ?>>OJT / Student Intern</option>
                                </select>
