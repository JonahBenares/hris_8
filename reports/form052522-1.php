...
<page size="A4">
    ...
    <div class="p-t-20 m-l-20 m-r-20">
        <table width="100%">
            ...
            <?php 
                $pre_add =  $row['provincial_address'] . ", " . getInfo($con, 'name', 'cities', 'id', $row['pre_city']).", ".getInfo($con, 'name', 'provinces', 'id', $row['pre_prov']);
                $perm_add =  $row['permanent_address'] . ", " . getInfo($con, 'name', 'cities', 'id', $row['perm_city']).", ".getInfo($con, 'name', 'provinces', 'id', $row['perm_prov']);
            ?>
            <tr>
