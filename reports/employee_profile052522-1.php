            ...
            <div class="card-body">                
                <table width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            <p class="m-b-0">
                                <?php echo $row['permanent_address'] .', '. getInfo($con, 'name', 'cities', 'id', $row['perm_city']).', '.getInfo($con, 'name', 'provinces', 'id', $row['perm_prov']);?>
                            </p>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td>
                            <p class="m-b-0">
                                <?php echo $row['provincial_address'].', '. getInfo($con, 'name', 'cities', 'id', $row['pre_city']).', '.getInfo($con, 'name', 'provinces', 'id', $row['pre_prov']); ?>
                            </p>
                        </td>
                    </tr>
                    <tr>
