...
$(function() {
    ...
    $('#remCertificate').live('click', function() { 
        ...
        var cert_id = document.getElementById('cert_id'+ct).value;
        $.ajax({
            url:"../reports/delete_certificate.php",
            method:"POST",
...
$(function() {
    ...
    $('#remEvaluation').live('click', function() { 
        ...
        // return false;
        var ct = $(this).attr('data');
        var eval_id = document.getElementById('eval_id'+ct).value;
        $.ajax({
            url:"../reports/delete_eval.php",
            method:"POST",
...
$(function() {
    ...
    $('#remOther').live('click', function() { 
        ...
        var other_id = document.getElementById('other_id'+ct).value;
...
$(document).ready(function(){
    ...
    $(document).on('click', '#remove_resume', function(){
        var personal_id = document.getElementById('id').value;
        $.ajax({
            url:"../reports/remove_resume.php",
            method:"POST",
    ...
    $(document).on('click', '#remove_essay', function(){
        var personal_id = document.getElementById('id').value;
        $.ajax({
            url:"../reports/remove_essay.php",
            method:"POST",
            data:'personal_id='+personal_id,
            success:function(data){
                                ...
                                <div style="margin-top:10px">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php } ?>
                                            <a href="#" id="remove_resume" class="btn btn-danger btn-sm btn-fill">x</a>
                                            <?php } ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php }  ?>
                                            <a href="#" id="remove_map" class="btn btn-danger btn-sm btn-fill">x</a>
                                            <?php } ?>
                                            <div id='mapBox'></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <?php } ?>
                                            <a href="#" id="remove_essay" class="btn btn-danger btn-sm btn-fill">x</a>
                                            <?php } ?>
                                            <div id='essayBox'></div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                           ...
                                           <?php } else { ?>
                                            ...
                                            <?php } ?>
                                            <a href="#" id="remove_photo" class="btn btn-danger btn-sm btn-fill">x</a>
                                            <?php } ?>
                                            <div id='photoBox'></div>
                                        </div>       
                                ...
                                <div id = "p_certificate">
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="hidden" name="cert_id1" id="cert_id1"  value="0"> 
                                        </div>                                
                                        <div class="col-lg-3">
                                  ...
                                  while($fetch_cert = $getcert->fetch_array()){ ?>
                                   <div id = "p_certificate">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="#" class="btn btn-primary btn-sm btn-fill" id="addCertificate">+</a>  
                                            <a href="#" class="btn btn-danger btn-sm btn-fill" id="remCertificate" data="<?php echo $a; ?>">x</a>
                                        </div>
                                    </div>
                                ...
                                <div id = "p_evaluation">
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="hidden" name="eval_id1" id="eval_id1" value="0">
                                        </div>                                
                                        <div class="col-lg-3">
                                  ...
                                  while($fetch_eval = $geteval->fetch_array()){ 
                                   ...
                                   ?>
                                    ...
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-3">
                                            <a href="#" class="btn btn-primary btn-sm btn-fill" id="addEvaluation">+</a> 
                                            <a href="#" class="btn btn-danger btn-sm btn-fill" id="remEvaluation" data='<?php echo $b; ?>'>x</a>
                                        </div>
                                ...
                                <div id = "p_other">
                                    <div class="row" >
                                        ...
                                        <div class="col-lg-3">
                                            ...
                                            <input type="hidden" name="other_id1" id="other_id1"  value="0"> 
                                        </div>                                
                                        <div class="col-lg-3">
                                ...
                                <?php } else { 
                                  ...
                                  while($fetch_other = $getother->fetch_array()){ ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3">
                                            <a href="#" class="btn btn-primary btn-sm btn-fill" id="addOther">+</a> 
                                            <a href="#" class="btn btn-danger btn-sm btn-fill" id="remOther" data='<?php echo $r; ?>'>x</a>
                                        </div>
                                    </div>
