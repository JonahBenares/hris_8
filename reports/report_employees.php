                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-1 p-l-0">
                                <?php if(isset($_POST['keyword'])){ ?>
                                    <a href="export_employees.php?keyword=word&filter=<?php echo $filter; ?>" class="btn btn-warning btn-sm btn-block alert-export text-white"><b>EXPORT</b></a>
                            ...
                            <table id="dataTables-example" class="table table-bordered table-hover">
                                <thead>
                                    <tr style="background: #fff1">
                                        ...
                                        <th width="10%" ><center>Employee No.</center></th>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <center>
                                                ...
                                                <?php } else if($row['emp_status'] == 'Pass') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-pass" data-toggle="modal">Pass</a>
                                                <?php } else if($row['emp_status'] == 'For Pooling') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-pool" data-toggle="modal">For Pooling</a>
                                                <?php } else if($row['emp_status'] == 'For Interview') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-interview" data-toggle="modal">For Interview</a>
                                                <?php } else if($row['emp_status'] == 'For Exam') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-exam" data-toggle="modal">For Exam</a>
                                                <?php } else if($row['emp_status'] == 'Part-Time') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-parttime" data-toggle="modal">Part-Time</a>
                                                <?php } else if($row['emp_status'] == 'Retainer') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-retainer" data-toggle="modal">Retainer</a>
                                                <?php } else if($row['emp_status'] == 'OJT / Student Intern') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-ojt" data-toggle="modal">OJT / Student Intern</a>
                                                <?php } else if($row['emp_status'] == 'Fixed-Term Worker') { ?>  
                                                <a onclick='check(<?php echo $row[ 'personal_id']; ?>)' class="lbl lbl-ftw" data-toggle="modal">Fixed-Term Worker</a>
                                                <?php } else{ ?>
                                                <?php } ?>                                                
                                            </center>
