    ...
    <div class="p-t-20 m-l-20 m-r-20">
        <table width="100%">
                    ...
                    <b>
                        <?php
                            if(empty($row['date_applied'])){
                                ...
                                $date_ap = date('F j, Y',strtotime($row['date_applied']));
                               echo "$date_ap";
                            }
                        ?> 
                    </b>
            ...
            <tr>
                ...
                <td colspan="6" class="bor-btm font-12">
                    <b>
                        ₱<?php echo number_format($row['sal_from'],2);?> -- ₱<?php echo number_format($row['sal_to'],2);?>
                    </b>
                </td>
                    ...
                    <b>
                        <?php
                            if(empty($row['date_available'])){
                                ...
                                $date_avail = date('F j, Y',strtotime($row['date_available']));
                               echo "$date_avail";
                            }
                        ?> 
                    </b>
            ...
            <tr>
                ...
                <td class="bor-right" colspan="1"><b><?php echo (!empty($row['n_bday'])) ? computeAge($row['n_bday']) : $row['n_age'];?></b></td>
                <td class="bor-right" colspan="2"><b><?php echo (!empty($row['n_bday'])) ? $row['n_bday'] : '';?></b></td>                
                    ...
                    <b>
                        <?php
                            if(empty($row['p_date_graduated'])){
                                ...
                                $date_grad = ($row["p_date_graduated"]);
                            }
                            echo $date_grad;
                        ?>
                    </b>
            ...
            <tr>
                <td class="bor-btm" colspan="20"><strong>EMPLOYMENT HISTORY (FROM RECENT TO PAST)</strong></td>
            </tr>
            <?php                        
                $query4 = mysqli_query($con,"SELECT * FROM employment_history WHERE personal_id = '$id'");
                $rows =mysqli_num_rows($query4);
                $query5 = mysqli_query($con,"SELECT * FROM training_seminars WHERE personal_id = '$id'");
                $rows1 =mysqli_num_rows($query5);
                if ($rows != 0 ){ ?>
            <tr>
            ...
            <?php  }else{ ?>
                <tr><td class="bor-right bor-btm" colspan="20" align="center"><strong>No Available Data...</strong></td></tr>
            <?php } ?>
            <?php                        
                if ($rows != 0 ){
            ...
            <tr>
                ...
                ?>
 -->                <td class="bor-right bor-btm" colspan="2" align="center"><b><?php echo $row4['em_from']?></b></td>
                <td class="bor-right bor-btm" colspan="2" align="center"><b><?php echo $row4['em_to'] ?></b></td>
                <td class="bor-right bor-btm" colspan="3" align="center"><b><?php echo $row4['em_remarks']?></b></td>
            </tr>
            <?php } }?> 
            <?php 
            if (($rows == 0 || $rows <= 5) && ($rows1 == 0 || $rows1 == 1)) {?>
            <tr>
                <td colspan="20" class="bor-btm"><strong>TRAININGS AND SEMINARS ATTENDED:</strong></td>
            </tr>
            <?php                        
                if ($rows1 != 0){ ?>
            <tr>
                <td class="bor-right bor-btm" colspan="6" align="center">TITLE</td>
                <td class="bor-right bor-btm" colspan="5" align="center">VENUE</td>
                <td class="bor-right bor-btm" colspan="6" align="center">ORGANIZER</td>
                <td class="bor-right bor-btm" colspan="3" align="center">DATE</td>
            </tr>
             <?php  }else{ ?>
            <tr><td class="bor-right bor-btm" colspan="20" align="center"><strong>No Available Data...</strong></td></tr>
             <?php } ?>
            ...
            <tr>
                <td class="bor-right bor-btm" colspan="6" align="center"><?php echo $row5['title']?></td>
                <td class="bor-right bor-btm" colspan="5" align="center"><?php echo $row5['venue']?></td>
                <td class="bor-right bor-btm" colspan="6" align="center"><?php echo $row5['organizer']?></td>
                <td class="bor-right bor-btm" colspan="3" align="center"><?php echo $row5['training_date']?></td>
            </tr>
            <?php  } } } ?>       
        </table>
    </div>
...
<page size="A4">
    <div class="p-t-20 m-l-20 m-r-20">
        <table width="100%">
            ...
            <?php  } } } ?>
<!--             <tr>
                <td class="bor-right bor-btm" colspan="6" align="center"><br></td>
                <td class="bor-right bor-btm" colspan="5" align="center"></td>
                <td class="bor-right bor-btm" colspan="6" align="center"></td>
            ...
            <tr>
                ...
                <td class="bor-right bor-btm" colspan="3" align="center">CONTACT NUMBER</td>
            </tr>
            <?php
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td class="bor-btm" colspan="14" align="center">
                    <br>I HERBY CERTIFY THAT THE INFORMATION GIVEN IS TRUE AND CORRECT AND THAT IT HAS BEEN MADE IN GOOD FAITH TO THE BEST OF MY KNOWLEDGE AND BELIEF.
                    <br>
                    <br>
                </td> 
                <td class="bor-btm" colspan="3"></td>
