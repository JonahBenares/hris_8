                                ...
                                <tbody>
                                    ...
                                    while($fetchDept = $getDept->fetch_array()){ 
                                       ...
                                       $trainee= getEmpStatusCount($con,$fetchDept['dept_id'],'current_dept', 'Trainee');
                                        ...
                                        $part_time= getEmpStatusCount($con,$fetchDept['dept_id'],'current_dept', 'Part-Time');
                                        $retainer= getEmpStatusCount($con,$fetchDept['dept_id'],'current_dept', 'Retainer');
                                        $ojt_student_intern= getEmpStatusCount($con,$fetchDept['dept_id'],'current_dept', 'OJT / Student Intern');
                                        
                                        $total = $regular+$probi+$trainee+$project+$consultant+$part_time+$retainer+$ojt_student_intern;
                                        $ttl[]=$total; ?>
                                        <tr>
                                            ...
                                            <td style='font-weight:bold;text-align:center'><?php echo (($part_time!=0) ? $part_time : ''); ?></td>
                                            <td style='font-weight:bold;text-align:center'><?php echo (($retainer!=0) ? $retainer : ''); ?></td>
                                            <td style='font-weight:bold;text-align:center'><?php echo (($ojt_student_intern!=0) ? $ojt_student_intern : ''); ?></td>
                                            <td style='font-weight:bold;text-align:center; text-align:center'><?php echo (($total!=0) ? $total : ''); ?></td>
                                        </tr>
                                    <?php } ?>
                                    <tr style="background: #fff2">
                                        <td colspan='9' style='font-weight:bold; text-align:right; border-top:2px solid'>Total Count:</td>
                                ...
                                <tbody>
                                    ...
                                    while($fetchBU = $getBU->fetch_array()){ 
                                       ...
                                       $trainee= getEmpStatusCount($con,$fetchBU['bu_id'],'current_bu', 'Trainee');
                                        ...
                                        $part_time= getEmpStatusCount($con,$fetchBU['bu_id'],'current_bu', 'Part-Time');
                                        $retainer= getEmpStatusCount($con,$fetchBU['bu_id'],'current_bu', 'Retainer');
                                        $ojt_student_intern= getEmpStatusCount($con,$fetchBU['bu_id'],'current_bu', 'OJT / Student Intern');
                                        $total = $regular+$probi+$trainee+$project+$consultant+$part_time+$retainer+$ojt_student_intern;
                                        $ttl1[]=$total; ?>
                                        <tr>
                                ...
                                <tbody>
                                    ...
                                    while($fetchLoc= $getLoc->fetch_array()){ 
                                       ...
                                       $trainee= getEmpStatusCount($con,$fetchLoc['location_id'],'current_location', 'Trainee');
                                        ...
                                        $part_time= getEmpStatusCount($con,$fetchLoc['location_id'],'current_location', 'Part-Time');
                                        $retainer= getEmpStatusCount($con,$fetchLoc['location_id'],'current_location', 'Retainer');
                                        $ojt_student_intern= getEmpStatusCount($con,$fetchLoc['location_id'],'current_location', 'OJT / Student Intern');
                                        $total = $regular+$probi+$trainee+$project+$consultant+$part_time+$retainer+$ojt_student_intern;
                                        $ttl2[]=$total;  ?>
                                        <tr>
