                            ...
                            <table id="data-table" class="table table-bordered table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="center" class="emp-td"  style="text-transform:uppercase;font-weight:700;"><?php echo ($row['progen_flag']==0) ? 'CENPRI' : 'PROGEN';?></td>
                                        <td >
                                            <center >
                                                <?php if($row['progen_flag']==0){ ?>
                                                ...
                                                <?php }else{ ?>
                                                    <a href='../forms/amendment_form_draft_progen.php?amend_id=<?php echo $row['amendment_id']; ?>' class="btn btn-sm btn-primary" title='Update Amendment' alt='Update Amendment' data-toggle="tooltip"data-placement="top">
                                                        <span class="zmdi zmdi-edit" ></span>
                                                    </a>
                                                <?php } ?>
                                            </center>
