...
<section class="content">
    <div class="content__inner content__inner--sm">
            ...
            <div class="btn-group">
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu">
                        ...
                        <a class="dropdown-item" onclick="training()">Trainings and Seminars Attended</a>
                    </div>
                </div>
                <div class="btn-group" role="group">
                    <button type="button" class="btn btn-light dropdown-toggle" style="background: #fff0" data-toggle="dropdown">
        ...
        <div class="card animated fadeIn" id="training">
            <div class="card-header">
                <h4 class=" mb-0">Trainings and Seminars Attended</h4>
            </div>
            <div class="card-body">
                <table class="table" style="border-right: 1px solid grey;border-left: 1px solid grey;border-bottom: 1px solid grey;border-top: 1px solid grey;" >
                    <thead> 
                    ...
                    <tbody>
                        <?php
                            $query35 = mysqli_query($con,"SELECT * FROM training_seminars WHERE personal_id = '$id'")or die(mysqli_error($con));
                            $rows20 = $query35->num_rows;   
                            if($rows20 != 0 ){                              
                                while($row46 = mysqli_fetch_array($query35)){
                        ?>  
                        <tr>                                    
                            <td><?php echo $row46['title']?></td>
                            <td><?php echo $row46['venue']?></td>
                            <td><?php echo $row46['organizer']?></td> 
                            <td><?php echo $row46['training_date']?></td>                                     
                        </tr>
                        <?php  } } else {  ?>
                        <tr>                                    
                            <td colspan='4'>No Available Data</td>                              
