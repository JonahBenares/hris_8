                    ...
                    <div class="card-body">
                        <div class="row m-b-30">
                            <div class="col-lg-9">
                                ...
                                <h6 class="card-subtitle">Happy Birthday! Happy Birthday! </h6>
                            </div>
                            <div class="col-lg-3">
                                <div class="d-flex flex-row-reverse">
                                    <a href="../reports/print_birthday.php?birthday=<?php echo date('m'); ?>" target='_blank' class="btn btn-success btn-xs" style=""><span class="zmdi zmdi-print"></span></a>
                                </div>
                            </div>
                        </div>
