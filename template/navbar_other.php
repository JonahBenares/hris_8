    ...
    <main class="main">
        ...
        <header class="header">
            ...
            <div class="logo hidden-sm-down">
                <h1><a href="../masterfile/home.php"><b>CENPRI </b>- HRIS</a></h1>
            </div>
                ...
                <ul class="navigation">
                    ...
                    <li class="navigation__sub ">
                        ...
                        <ul class="navigation__sub">
                            ...
                            <li class=""><a href="../forms/amendment_form.php">Employee Amendment Form (CENPRI)</a></li>
                            <li class=""><a href="../forms/amendment_form_progen.php">Employee Amendment Form (PROGEN)</a></li>
                        </ul>
                    </li>
                    <li class="navigation__sub ">
