                                    ...
                                    <form id ="add-amendment" name = "add-amendment" method='POST'>
                                        ...
                                        <table style="width: 100%" style = "border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="bord-noleft">: <span id='end_contract'><?php echo ($emp_status == "Regular")? "-" : ((!empty($end_contract)) ? date("F d, Y", strtotime($end_contract)) : '');?></span></td>                                            </tr>
                                            <tr>
                                                ...
                                                <td class="nobor">
                                                    ...
                                                    <table style="width: 100% ">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="nobor" style="border-top: 1px solid #000" align="center"><span id='sup_designation'><?php echo strtoupper($sup_designation); ?></span></td>
                                                            <td class="nobor" width="10%"></td>
