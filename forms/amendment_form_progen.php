                                        ...
                                        <table style="width: 100%" style = "border-collapse: collapse;">
                                            ...
                                            <tr>
                                                ...
                                                <td width="25%" class="bord-noleft" style="padding: 0px">
                                                    ...
                                                    <input class="form-control" list="employees" name="employee_name" id="employee_name" onchange="chooseEmployee()">
                                                    ...
                                                    <input type="hidden" id="ins_employee" name="ins_employee">
                                                </td>
                                        ...
                                        <table style="width: 100%;border-collapse: collapse;border:1px solid #000;border-top: 0px solid">
                                            <tr>
                                                ...
                                                <td class="nobor" style="padding: 0px">
                                                    <textarea class="form-control" name="remarks" id="remarks" rows="2" style="color:#000"></textarea>
                                                </td>
                                            </tr>
                                        </table>
                                        <table style="width: 100%;border-collapse: collapse;border:1px solid #000;border-top: 0px solid">
                                                    ...
                                                    <table style="width: 100% ">
                                                        <tr>
                                                            ...
                                                            <td class="nobor" align="center" style="padding: 0px" width="20%">
                                                                ...
                                                                <input type="hidden" class="form-control" id="current_supid" name="current_supid"> 
                                                                <select class="form-control" name="current_sup" id="current_sup" onchange="chooseEmployeePos()" style="text-align: center;">
                                                                    <!-- <option value=""></option>
                                                                    <?php 
                                                                        $sql=mysqli_query($con,"SELECT * FROM personal_data WHERE current_dept!=0 AND ((fname LIKE '%Eric%' AND lname LIKE '%Jabiniar%') OR (fname LIKE '%Merry Michelle%' AND lname LIKE '%Dato%'))  ORDER BY lname ASC");
                                                                        while($rows=mysqli_fetch_array($sql)){
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="nobor" width="5%"></td>
                                                            <td class="nobor" style="border-top: 1px solid #000;text-transform: uppercase;" align="center"><span id='sup_designation'></span></td>
                                                            <td class="nobor" width="5%"></td>
                                                            <td class="nobor" style="border-top: 1px solid #000" align="center">CENPRI GENERAL MANAGER</td>
                                                            <td class="nobor" width="5%"></td>
                                                            <td class="nobor" style="border-top: 1px solid #000;" align="center" width="23%">PROGEN GENERAL MANAGER / EPIIC EXECUTIVE DIRECTOR</td>
                                                        </tr>
                                                    </table>
                                                </td>
                                            </tr>
