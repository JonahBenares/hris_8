<?php
	...
	if($amend_id==''){
		...
		if($progen_flag==0){
			mysqli_query($con,"INSERT INTO amendment (amendment_id,personal_id, date_prepared, date_effectivity, change_reason, remarks, dept_head,current_sup,saved,save_date,saved_by,progen_flag) VALUES('$amendment_id','$ins_employee','$date_prepared','$date_effectivity','$change_reason','$remarks','$current_supid','$current_sup','1','$save_date','$user_id','0')");
		}else{
			mysqli_query($con,"INSERT INTO amendment (amendment_id,personal_id, date_prepared, date_effectivity, change_reason, remarks, dept_head,current_sup,saved,save_date,saved_by,progen_flag) VALUES('$amendment_id','$ins_employee','$date_prepared','$date_effectivity','$change_reason','$remarks','$current_supid','$current_sup','1','$save_date','$user_id','1')");
		}
		echo $amendment_id;
		...
		$save_date=date("Y-m-d");
		if($progen_flag==0){
			mysqli_query($con,"UPDATE amendment SET personal_id='$ins_employee', date_prepared='$date_prepared', date_effectivity='$date_effectivity', change_reason='$change_reason', remarks='$remarks', dept_head='$current_supid', current_sup='$current_sup', draft='0', draft_date='', saved='1', save_date = '$save_date', saved_by='$user_id', progen_flag='0' WHERE amendment_id = '$amend_id'");
		}else{
