<?php
	...
	if($amend_id==''){
		...
		mysqli_query($con,"INSERT INTO amendment (amendment_id,personal_id, date_prepared, date_effectivity, change_reason, remarks, dept_head,current_sup,saved,save_date,saved_by) VALUES('$amendment_id','$employee_name','$date_prepared','$date_effectivity','$change_reason','$remarks','$current_supid','$current_sup','1','$save_date','$user_id')");
		echo $amendment_id;
	}else{
		$count= count($_POST['change_name']);
		for($x=0; $x<$count;$x++){
